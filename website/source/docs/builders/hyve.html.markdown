---
description: |
    The hyve Packer builder is able to create bhyve and xhyve virtual machine images.
    This builder is in BETA at this time.
layout: docs
page_title: bhyve / Xhyve Builder
...
...
The Hyve Packer builder is able to create [bhyve](http://bhyve.org/) and
[xhyve](http://www.xhyve.org/) virtual machine images. This builder is
